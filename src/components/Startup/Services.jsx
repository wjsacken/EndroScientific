    ...
    <section className="services section-padding style-6" data-scroll-index="2">
      ...
      <div className="content">
            ...
            >
              {
                servicesData.map((service, index) => (
                  <SwiperSlide key={index}>
                    <Link to={`/${rtl ? 'rtl-page-services':'page-services-5'}`} className="service-card style-6">
                      <div className="icon">
        ...
        <div className="text-center">
          <Link to={`/${rtl ? 'rtl-page-services':'page-services-5'}`} className="btn rounded-pill butn-blue6 hover-blue2 sm-butn fw-bold me-3">
