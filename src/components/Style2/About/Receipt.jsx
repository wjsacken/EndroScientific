          ...
          <div className="col-lg-12">
            <div className="info px-lg-5">
              <div className="section-head style-5 mb-40">
                <h2 className="mb-20"> Receipt <span> of Goods </span> </h2>
              </div>
              <div className="col-lg-12">
                <h2>We thoroughly inspect your unit before it ships. Freight damage occurs infrequently, but it does happen. Please help us protect your investment by receiving your 
                  new unit(s) with attention to detail.</h2>
                <p>Please review and document damage during delivery to avoid liability for return shipping and repair costs. We want to make sure that doesn't happen. Please ensure you 
                  or the assigned receiving party thoroughly review this unit before the freight company arrives. We can only file claims for freight damage if you identify and note the bill of lading (BOL and/or delivery paperwork) and ensure the delivery driver accepts and signs.</p>
                <p>Things to look for and note on the BOL:</p>
                <ul>
                  <li>A broken pallet may mean your unit has been dropped and can cause internal damage.</li>
                  <li>Tilt meters indicate that the unit has not remained upright in transit or has experienced a high degree of impact during transit.</li>
                  <li>Box crushing, holes, or tears in the outer packaging.</li>
                </ul>
                ...
                <h3>What if the carrier won't wait for me to inspect the freight?</h3>
