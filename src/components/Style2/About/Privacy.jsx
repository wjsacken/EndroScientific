        ...
        <div className="row align-items-center">
          <div className="col-lg-12">
            <div className="info px-lg-5">
              ...
              <div className="col-lg-12">
                <p>Please read our privacy policy carefully to understand how we collect, use, protect or otherwise handle your Personally Identifiable Information per our website.</p>
                <p>This privacy policy has been compiled to better serve those who are concerned with how their ‘Personally Identifiable Information’ (PII) is being used online. As described in US privacy law and information security, PII is information that can be used on its own or with other information to identify, contact, or locate a single person or identify an individual in context.</p>
                <h3>What personal information do we collect from the people that visit our blog, website, or app?</h3>
                <p>When you order or register on our site, as appropriate, you may be asked to enter your name, email address, mailing address, phone number, credit card information, Company Name, or other details to help you with your experience.</p>
                ...
                <ul>
                <li>To personalize your experience and allow us to deliver the type of content and product offerings you are most interested in.</li>
                ...
                <p>Your personal information is contained behind secured networks. It is only accessible by a limited number of persons with special access rights to such systems and must keep the information confidential. In addition, all sensitive/credit information you supply is encrypted via Secure Socket Layer (SSL) technology.</p>
                <p>We implement a variety of security measures when a user places an order enters, submits, or accesses their information to maintain the safety of your personal information.</p>
                <p>All transactions are processed through a gateway provider and are not stored or processed on our servers.</p>
                <h3>Do we use ‘cookies’?</h3>
                <p>Yes. Cookies are small files that a site or its service provider transfers to your computer’s hard drive through your Web browser (if you allow), enabling the site’s or service provider’s systems to recognize your browser and capture and remember certain information. For instance, cookies help us remember and process the items in our shopping cart. They are also used to help us understand your preferences based on previous or current site activity, which enables us to provide you with improved services. We also use cookies to help us compile aggregate data about site traffic and interaction to offer better site experiences and tools in the future.</p>
                <p>We use cookies to:</p>
                <ul>
                <li>Please help me remember and process the items in the shopping cart.</li>
                ...
                <p>You can have your computer warn you each time a cookie is being sent, or you can turn off all cookies. You do this through your browser settings. Since the browser is a little different, look at your browser’s Help Menu to learn how to modify your cookies.</p>
                <p>If users disable cookies in their browsers:</p>
                <p>If you turn cookies off, some of the features that make your site experience more efficient may not function properly. Some of the features that make your site experience more efficient may need to be fixed.</p>
                <h3>Third-Party Disclosure</h3>
                <p>We do not sell, trade, or otherwise transfer your Personally Identifiable Information to outside parties.</p>
                <h4>Third-Party Links</h4>
                <p>We do not include or offer third-party products or services on our website. Google</p>
                <p>Google’s Advertising Principles can sum up Google’s advertising requirements. They are put in place to provide a positive experience for users.</p>
                <p>We use Google AdSense Advertising on our website.</p>
                <p>As a third-party vendor, Google uses cookies to serve ads on our site. Google’s use of the DART cookie enables it to serve ads to our users based on previous visits to our site and other sites on the Internet. Users may opt out of using the DART cookie by visiting the Google Ad and Content Network privacy policy.</p>
                ...
                <li>Our Privacy Policy link includes the word ‘Privacy’ and can easily be found on the abovementioned page.</li>
                </ul>
                ...
                <p>We also agree to the Individual Redress Principle, which requires that individuals have the right to legally pursue enforceable rights against data collectors and processors who fail to adhere to the law. This principle requires that individuals have enforceable rights against data users and have recourse to courts or government agencies to investigate and/or prosecute non-compliance by data processors.</p>
                <h3>CAN SPAM Act</h3>
                ...
                <ul>
                <li>Please don't use false or misleading subjects or email addresses.</li>
                <li>Identify the message as an advertisement in some reasonable way.</li>
                <li>Include the physical address of our business or site headquarters.</li>
                <li>Monitor third-party email marketing services for compliance if one is used.</li>
                <li>Honor opt-out/unsubscribe requests quickly.</li>
                <li>Allow users to unsubscribe using the link at the bottom of each email.</li>
                </ul>
                <p>If at any time you would like to unsubscribe from receiving future emails, you can email us at</p>
                <ul>
                <li>Please follow the instructions at the bottom of each email, and we will quickly remove you from ALL correspondence.</li>
                </ul>
                <h4>CONTACTING US</h4>
